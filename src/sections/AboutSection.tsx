      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="max-w-2xl text-base leading-8 text-slate-600">{aboutCopy.body2}</p>
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[40px] border border-slate-200 bg-[linear-gradient(180deg,#ffffff,#f8fafc)] shadow-soft transition-all duration-300 hover:-translate-y-1 hover:scale-[1.01] hover:shadow-[0_24px_80px_rgba(17,24,39,0.12)]">
              <img src={categories[0].image} alt="About KAMI" className="h-full w-full object-cover transition duration-300 hover:scale-[1.02]" loading="eager" />
              ...
              <div className="absolute bottom-5 left-5 right-5 grid gap-3 sm:grid-cols-2">
                <div className="rounded-[24px] border border-white/[0.15] bg-white/[0.12] p-4 text-white backdrop-blur-md">
                  <p className="text-xs uppercase tracking-[0.24em] text-cyan-200">What we bridge</p>
                  <p className="mt-2 text-sm leading-7">Corporate expectations and creative agency execution.</p>
                </div>
                <div className="rounded-[24px] border border-white/[0.15] bg-white/[0.12] p-4 text-white backdrop-blur-md">
                  <p className="text-xs uppercase tracking-[0.24em] text-cyan-200">What we protect</p>
                  <p className="mt-2 text-sm leading-7">Quality, budget, and creativity in one balanced process.</p>
                </div>
              </div>
            </div>
          </motion.div>

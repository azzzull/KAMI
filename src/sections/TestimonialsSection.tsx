...
export function TestimonialsSection() {
  return (
    <section className="relative overflow-hidden bg-[linear-gradient(180deg,#ffffff,#f8fafc)] py-20 sm:py-24 lg:py-28">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12">
          <Swiper
            ...
            loop
            slidesPerView={1}
            cardsEffect={{ slideShadows: false, perSlideOffset: 9, perSlideRotate: 1 }}
            className="testimonial-swiper mx-auto max-w-4xl !overflow-visible"
          >
              ...
              <SwiperSlide key={testimonial.name}>
                <div className="relative mx-auto max-w-3xl py-6">
                  ...
                  <motion.article
                    ...
                    className="relative overflow-hidden rounded-[32px] border border-slate-200 bg-white p-8 shadow-[0_14px_40px_rgba(17,24,39,0.08)] ring-1 ring-black/5 sm:p-10"
                  >
                    ...
                    <p className="text-xl font-medium leading-9 text-slate-800 sm:text-2xl">&quot;{testimonial.quote}&quot;</p>
                    <div className="mt-8 flex items-center gap-4">
                      <div className="grid h-14 w-14 place-items-center rounded-2xl bg-[linear-gradient(135deg,#EC198B,#6B1FAF,#1E3FAE)] text-sm font-bold text-white shadow-soft">
                        {testimonial.name
                          .split(' ')
                          .map((part) => part[0])
                          .slice(0, 2)

    ...
    <section className="relative overflow-hidden pt-28 sm:pt-32 lg:pt-36">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-4 pb-16 sm:px-6 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:pb-24">
        <div className="flex flex-col justify-center">
          ...
          >
            KAMI Event Management bridges corporate expectations and creative execution with a team that understands
            ...
            {heroCards.map((card, index) => {
              ...
              return (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.55, delay: 0.08 + index * 0.04, ease }}
                ...
                >
                  ...
                  <h3 className="mt-4 text-sm font-bold text-slate-950">{card.title}</h3>
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="absolute -left-3 top-10 h-36 w-28 overflow-hidden rounded-[28px] border border-white/60 bg-white/70 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-[0_24px_60px_rgba(17,24,39,0.14)] sm:h-44 sm:w-36">
              <img src={categories[1].image} alt="Event visual 1" className="h-full w-full object-cover transition duration-300" loading="eager" />
            </div>
            <div className="absolute -right-1 top-14 h-44 w-32 overflow-hidden rounded-[28px] border border-white/60 bg-white/70 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-[0_24px_60px_rgba(17,24,39,0.14)] sm:h-52 sm:w-40">
              <img src={categories[2].image} alt="Event visual 2" className="h-full w-full object-cover transition duration-300" loading="eager" />
            </div>
            <div className="absolute bottom-0 left-0 right-0 top-16 overflow-hidden rounded-[40px] border border-white/60 bg-white/75 shadow-soft backdrop-blur">
              <img src={categories[0].image} alt="KAMI event collage" className="h-full w-full object-cover transition duration-300 hover:scale-[1.02]" loading="eager" />
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <p className="text-xs uppercase tracking-[0.26em] text-cyan-200">Project Focus</p>
                    <p className="mt-2 text-lg font-bold">Corporate, brand, exhibition, and live formats</p>
                  </div>
                  <Link
                    to="/portfolio"
          ...
          >
            <div className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Creative Direction</div>
            <p className="mt-2 max-w-44 text-sm leading-6 text-slate-600">Curved compositions and controlled energy.</p>
          </motion.div>
        </div>
      </div>
    </section>
